...
public class MyDateAxis extends DateAxis{
	...
	public MyDateAxis(String timeAxisLabel) {
		super(timeAxisLabel);
	}
	...
	public static TickUnitSource createStandardDateTickUnits(TimeZone zone,
        ...
        // date formatters
        DateFormat f1  =new SimpleDateFormat("d-MMM-yyyy HH:mm:ss.SSS", locale);
        DateFormat f2 = new SimpleDateFormat("d-MMM-yyyy HH:mm:ss", locale);
        DateFormat f3 = new SimpleDateFormat("d-MMM-yyyy HH:mm", locale);
